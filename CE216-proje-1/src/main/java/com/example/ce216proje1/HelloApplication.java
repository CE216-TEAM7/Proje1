...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        //ENG-FRA
        try {
            Scanner scanner = new Scanner(new File("src/main/java/com/example/ce216proje1/Dictionary/eng-fra.dict")); // Open the text file for reading
            String word = "";
            ArrayList<String> translation = new ArrayList<>();
        ...
        //ELL-ITA
        try {
            File file = new File("src/main/java/com/example/ce216proje1/Dictionary/ell-ita.dict");
            Scanner scanner = new Scanner(file);
            String word = "";
            while (scanner.hasNextLine()) {
                String line = scanner.nextLine();
        ...
        //ELL-SWE
        try {
            File file = new File("src/main/java/com/example/ce216proje1/Dictionary/ell-swe.dict");
            Scanner scanner = new Scanner(file);
            String word = "";
            while (scanner.hasNextLine()) {
                String line = scanner.nextLine();
        ...
        //FRA-TUR
        try {
            Scanner scanner = new Scanner(new File("src/main/java/com/example/ce216proje1/Dictionary/fra-tur.dict")); // Open the text file for reading
            String word = "";
            ArrayList<String> translation = new ArrayList<>();
        ...
        //FRA-ENG
        try {
            Scanner scanner = new Scanner(new File("src/main/java/com/example/ce216proje1/Dictionary/fra-eng.dict")); // Open the text file for reading
            String word = "";
            ArrayList<String> translation = new ArrayList<>();
        ...
        //ITA-ENG
        try {
            Scanner scanner = new Scanner(new File("src/main/java/com/example/ce216proje1/Dictionary/ita-eng.dict")); // Open the text file for reading
            String word = "";
            ArrayList<String> translation = new ArrayList<>();
        ...
        //GER-ITA
        try {
            Scanner scanner = new Scanner(new File("src/main/java/com/example/ce216proje1/Dictionary/deu-ita.dict")); // Open the text file for reading
            String word = "";
            ArrayList<String> translation = new ArrayList<>();
